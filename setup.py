...
VERSION = get_version('esewa', '__init__.py')
...
setup(
    name='esewa',
    version=VERSION,
    description="""It is the custom plugin for openedx ecommerce.""",
    long_description=README + '\n\n' + CHANGELOG,
    author='mydl project',
    author_email='dibug@gmail.com',
    url='https://github.com/subodhpoudel12/ecommerce-esewa',
