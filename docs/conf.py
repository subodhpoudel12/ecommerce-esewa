...
"""
esewa documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'ecommerce-esewa',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/subodhpoudel12/ecommerce-esewa",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'It is the custom plugin for openedx ecommerce.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'esewa'),
                os.path.join(root_path, 'esewa/migrations')])
